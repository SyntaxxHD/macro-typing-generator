...
function generateMacro() {
  ...
  if (error) {
    document.getElementById('error-message').innerHTML = ''
    document.getElementById('error-message').innerHTML = window.langNoKey
    ...
    document.getElementById('error-message').innerHTML = ''
    document.getElementById('error-message').innerHTML = window.langNoDelay
    document.getElementById('loading-icon').style.display = 'none'
    document.getElementById('logo-icon').style.display = 'inline-flex'
    document.getElementById('progress-text').innerHTML = ''
    return
  ...
  document.getElementById('download-box').innerHTML = '<button class="btn download-btn" onclick="downloadXML()">' + window.langDownload + '</button>'
}
